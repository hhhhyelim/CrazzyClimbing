...
// ���� ���� ����
int currentNumber = randomDistribution(randomEngine); // ���� ������ �ʱ�ȭ
...
void Mode3::Update()
{
    ...
    if (game_start && !game_over) {
        ...
        // ������ �ִϸ��̼� �� �̵� ó��
        monkeyTimer++;
        if (monkeyTimer % 15 == 0) // 1�ʿ� �� ���� �ִϸ��̼� ����
        {
            monkeyFrame = (monkeyFrame + 1) % 2; // monkey1.png�� monkey2.png ���̿��� �ݺ�
        }
