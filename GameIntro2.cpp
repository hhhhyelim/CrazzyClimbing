		...
		case SDL_MOUSEBUTTONDOWN:
			...
			if (event.button.button == SDL_BUTTON_LEFT) {
				...
				if (mouse_x >= g_destination_rectangle_play.x &&
					...
					SDL_RenderPresent(g_renderer);
					SDL_Delay(1000);  // Delay for 3 seconds
